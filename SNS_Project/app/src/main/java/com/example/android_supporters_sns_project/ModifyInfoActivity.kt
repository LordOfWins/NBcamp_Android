...
class ModifyInfoActivity : AppCompatActivity() {
        ...
        when (requestCode) {
            1000 -> {
                if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED)
                    ...
                    Toast.makeText(this, getString(R.string.modify_permission), Toast.LENGTH_SHORT)
                        .show()
            }
        }
    }
    ...
    private fun passwordTextWatcher() {
        ...
        passwordLayout.editText?.addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                Log.d("ModifyInfoActivity", "beforeTextChanged: $p0")
            }
            ...
            override fun afterTextChanged(s: Editable?) {
                Log.d("ModifyInfoActivity", "afterTextChanged: $s")
            }
        })
    }
    ...
    private val passwordCheckWatcher = object : TextWatcher {
        ...
        override fun afterTextChanged(p0: Editable?) {
            Log.d("ModifyInfoActivity", "afterTextChanged: $p0")
        }
    }
