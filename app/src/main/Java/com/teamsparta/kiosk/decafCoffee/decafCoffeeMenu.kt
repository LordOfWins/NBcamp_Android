...
import com.teamsparta.kiosk.decafCoffee.DecaffeineColdBrew
import com.teamsparta.kiosk.decafCoffee.DecaffeineColdBrewLatte
        ...
        when (confirm) {
            1 -> {
                val updatedCoffee = when (selectedCoffee) {
                    ...
                    is DecaffeineColdBrew -> DecaffeineColdBrew(
                        size = size,
                        temperature = temperature,
                        shot = shot,
                        packaging = packaging,
                    ...
                    is DecaffeineColdBrewLatte -> DecaffeineColdBrewLatte(
                        size = size,
                        temperature = temperature,
                        shot = shot,
                        packaging = packaging,
                ...
                OrderManager.items.add(OrderItem.DecafOrderItem(updatedCoffee, quantity))
                printOrderItems()
